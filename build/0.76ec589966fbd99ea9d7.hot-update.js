...
/***/ function(module, exports, __webpack_require__) {
	...
	var _WaitList = __webpack_require__(247);
	...
	var WaitList = function (_Component) {
		...
		_createClass(WaitList, [{
			...
			value: function addToList(patron, cell) {
				...
				console.log('kdjklsdjkasdjklsdjsld');
...
/***/ function(module, exports, __webpack_require__) {
	...
	var AddName = function (_Component) {
	    _inherits(AddName, _Component);

	    function AddName(props) {
	        _classCallCheck(this, AddName);

	        var _this = _possibleConstructorReturn(this, (AddName.__proto__ || Object.getPrototypeOf(AddName)).call(this, props));
	    ...
	    _createClass(AddName, [{
	        ...
	        value: function render() {
	            return _react2.default.createElement(
	                'form',
	                { onSubmit: this.handleAddName.bind(this) },
	                _react2.default.createElement('input', { type: 'text', placeholder: 'name', ref: 'createName' }),
	                _react2.default.createElement('input', { type: 'text', placeholder: 'cell number', ref: 'createCell' }),
	                _react2.default.createElement(
	                    'button',
	                    null,
	                    'Add Name'
	        ...
	        key: 'handleAddName',
	        value: function handleAddName(event) {
	            event.preventDefault();

	            var createName = this.refs.createName;
	            var patron = createName.value;
	            var validateInput = this.validateInput(patron);

	            var createCell = this.refs.createCell;
	        ...
	        key: 'validateInput',
	        value: function validateInput(patron) {
	            if (!patron) {
	                return 'Please enter patron.';
	            } else if (_.find(this.props.waitlist, function (item) {
	                return item.patron === patron;
	            })) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _waitlistPatron = __webpack_require__(250);

	var _waitlistPatron2 = _interopRequireDefault(_waitlistPatron);
	...
	var ListOfNames = function (_Component) {
	  _inherits(ListOfNames, _Component);

	  function ListOfNames() {
	    _classCallCheck(this, ListOfNames);

	    return _possibleConstructorReturn(this, (ListOfNames.__proto__ || Object.getPrototypeOf(ListOfNames)).apply(this, arguments));
	  }

	  _createClass(ListOfNames, [{
	    key: 'renderItems',
	    value: function renderItems() {
	      var _this2 = this;

	      return _.map(this.props.waitlist, function (person, index) {
	        return _react2.default.createElement(_waitlistPatron2.default, _extends({ key: index }, person, _this2.props));
	      });
	    }
	  }, {
	    key: 'render',
